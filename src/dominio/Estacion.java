...
public class Estacion implements Comparable<Estacion> {
    ...
    public int getOcupacion() {
        return ancladas.Longitud();
    }

    public int getCuposLibres() {
        return capacidad - ancladas.Longitud();
    }

    public boolean tieneAnclajeLibre() {
        return getCuposLibres() > 0;
    }
    ...
    //revisa si hay bicis en cola para anclar
    public String existenBicicletasParaAnclar() {
        String salida = "";
        if (!colaAnclaje.estaVacia()) {
            salida = colaAnclaje.desencolar();
        }
